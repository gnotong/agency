...
class Paginator
{
    ...
    const CRITERIA_NOT_DEFINED = 'Criteria need to be defined when defining your paginator service';
    ...
    public function getData(): array
    {
        ...
        if (empty($this->criteria)) {
            throw new \Exception(self::CRITERIA_NOT_DEFINED);
        }

        $offset = $this->currentPage * $this->limit - $this->limit;
        $repo   = $this->manager->getRepository($this->entityClass);

        return $repo->findBy($this->criteria, [], $this->limit, $offset);
    }
